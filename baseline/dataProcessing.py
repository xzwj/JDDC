...
def cutDataToTrainDevBy91():
    randomList = []
    with codecs.open("./data/test.enc", mode="w", encoding="utf-8") as wf_devQuestion:
        with codecs.open("./data/test.dec", mode="w", encoding="utf-8") as wf_devAnswer:
            with codecs.open("./data/train.enc", mode="w", encoding="utf-8") as wf_trainQuestion:
                with codecs.open("./data/train.dec", mode="w", encoding="utf-8") as wf_trainAnswer:
                    try:
    ...
    with codecs.open("./data/questions.txt", mode='r', encoding="utf-8") as rf_question:
        with codecs.open("./data/answers.txt", mode='r', encoding="utf-8") as rf_answer:
            try:
                ...
                with codecs.open("./data/test.enc", mode='a', encoding="utf-8") as wf_devQuestion:
                    with codecs.open("./data/test.dec", mode='a', encoding="utf-8") as wf_devAnswer:
                        try:
                            for i in randomList:
    ...
    with codecs.open("./data/questions.txt", mode='r', encoding="utf-8") as rf_question:
        with codecs.open("./data/answers.txt", mode='r', encoding="utf-8") as rf_answer:
            ...
            with codecs.open("./data/train.enc", mode='a', encoding="utf-8") as wf_question:
                with codecs.open("./data/train.dec", mode='a', encoding="utf-8") as wf_answer:
    ...
    os.remove("./data/questions.txt")
    os.remove("./data/answers.txt")
